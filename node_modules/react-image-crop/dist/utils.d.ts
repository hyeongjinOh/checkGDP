...
export declare function areCropsEqual(cropA: Partial<Crop>, cropB: Partial<Crop>): boolean;
export declare function makeAspectCrop(crop: Partial<Crop>, aspect: number, containerWidth: number, containerHeight: number): PixelCrop | PercentCrop;
export declare function centerCrop(crop: Partial<Crop>, containerWidth: number, containerHeight: number): PixelCrop | PercentCrop;
