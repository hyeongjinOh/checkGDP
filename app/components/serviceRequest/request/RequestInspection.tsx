          ...
          <div className="content__info">
            <ul className="form__input">
              ...
              <li>
                ...
                <div className="input__area">
                  <input type="text" className={` ${(errorList.filter(err => (err.field === "modelName")).length > 0) && " input-error"}`}
                    value={modelName} onChange={(e) => handleSetPModelName(e)}
              ...
              <li>
                ...
                <div className="input__area">
                  <input type="text" className={` ${(errorList.filter(err => (err.field === "serialNo")).length > 0) && " input-error"}`}
                    value={serialNo} onChange={(e) => handleSetSeralNo(e)}
                    placeholder="텍스트를 입력하세요." />
                  ...
                  <div className="searchterm">
                    <div className="term__date w100p">
                      <DatePicker
                        ...
                        className={`calendar end  ${(errorList.filter(err => (err.field === "buyDate")).length > 0) && " input-error"}`}
                      />
            ...
            <ul className="form__input">
              ...
              <li className="mt-80">
                <div className="btn__wrap right w100p">
                  {/* <button type="button" className="bg-gray js-open" data-pop="pop-chatbot" onClick={(e) => chtabotPop(e)}><span data-pop="pop-chatbot">취소</span></button> */}
                  {(mailReceiptSel == "true") ?
