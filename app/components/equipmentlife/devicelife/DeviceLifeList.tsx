...
import { useNavigate } from "react-router-dom";
 ...
 /**
 * @brief EHP 설비수명  - 수명인자 List 컴포넌트, 반응형 동작
 * @param -
 * @returns react components
 */

//component
function DeviceLifeList(props) {
    //trans
    const t = useTrans();
    //recoil
    ...
    const [fieldList, setFieldList] = useState([
        ...
        { "id": 7, "fdDisp": "Basic", "fdVal": null, "sort": "asc", "click": false },
        { "id": 8, "fdDisp": "Premium", "fdVal": null, "sort": "asc", "click": false },
        { "id": 9, "fdDisp": "Advanced", "fdVal": null, "sort": "asc", "click": false },

    ]);


    let appPath = selTree.room.roomId;
    ...
    }, [pageInfo.totalElements, reWork.room.roomId, selTree.room.roomId])
        ...
        <>
            <div className="area__right">
                ...
                <div className="inline mb-18">
                    ...
                    <a href="#" className="move-list" >{t("LABEL.수명인자설정")}</a>
                </div>
                ...
                <div className="area__right_content hcal-170">
                    ...
                    <div className="tbl-list td-h26 hcal-130">
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col"
                                        ...
                                        // onClick={(e) => onClickSortField(null)}
                                    >
                                        <span>{t("Basic")}</span>
                                    </th>
                                    <th scope="col"
                            ...
                            <tbody>
                                {(list) && list.map((list, idx) => (
                                    <tr key={"life_" + idx.toString()} onClick={(e) => updataClick(e, list)}>
                                        ...
                                        <td className="txt-left">{(list.basicAssess.totalScore !== null) ? list.basicAssess.totalScore : "-"}</td>
                                        <td className="txt-left">{(list.premiumAssess.totalScore !== null) ? list.premiumAssess.totalScore : "-"}</td>
                                        <td className="txt-left">{(list.advancedAssess.totalScore !== null) ? list.advancedAssess.totalScore : "-"}</td>
                                    </tr>
                                ))}
                            </tbody>
                        </table>
