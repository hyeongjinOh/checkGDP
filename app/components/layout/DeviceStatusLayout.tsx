...
import DeciveStatusMain from "../devicestatus/DeciveStatusMain ";
import axios from "axios";
import JSZip from "jszip";

function DeviceStatusLayout(props) {
  //recoil
  ...
  return (
    <>
      <div id="wrap">
        {/*<!-- #wrap -->*/}
        {<Header />}
        {(tabMenuList) && (curTabMenu) && <DeciveStatusMain
