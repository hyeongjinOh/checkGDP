/**
 * @url /devicelife, /devicelifereport
 * @CONST CONST.URL_DEVICESLIFE, CONST.URL_DEVICESLIFEREPORT
 * @menu 설비수명
 * @mapping 설비수명 인자설정 화면, 설비수명 Report 화면
 */
...
function EquipmentLifeLayout(props) {
  //recoil
  ...
  return (
    <>
      <div id="wrap">
        {/*<!-- #wrap -->*/}
        {<Header />}
        {(tabMenuList) && (curTabMenu) && <EquipmentLifeMain
...
export default EquipmentLifeLayout;
