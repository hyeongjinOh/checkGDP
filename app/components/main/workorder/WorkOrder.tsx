...
import { urlState, czoneInfoState } from "../../../recoil/menuState";
...
function WorkOrder(props) {
  ...
  function onClickGoLink(url) {
    setRecoilCZoneInfo({company:company, zone:zone});        
            ...
            <div className="box__status">
              <ul className="status__info">
                <li>
                  ...
                  <p><strong>{WorkorderItem.totalCount}</strong><span>{t("LABEL.개")}</span></p>
                </li>
              </ul>
