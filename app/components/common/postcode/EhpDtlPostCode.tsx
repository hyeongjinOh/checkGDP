...
/**
 * @brief EHP 점검 출동 요청 주소 검색 컴포넌트
 * @param - 
 * @returns react components
 */

function EhpDtlPostCode(props) {
  ...
  function onClickSaveAddress(e) {
    ...
    const allAddress = { zonecode: zonecode, address: address, deladdress: detailAddress};
  ...
  <>
    {/*<!--220926 주소찾기 팝업-->*/}
    <div id="pop-dtlpostcode" className="popup-layer js-layer layer-out hidden popup-address">
