 ...
 * @date 2022-11-29
 * @brief EHP 도움말 - utils 개발
 *
 ********************************************************************/
import React from "react";
/**
 * @brief EHP 도움말 - utils  컴포넌트
 * @param 
                ...
                snameContents: [
                    {
                        ...
                        captureImg: require(`/static/img/img_help/1.Login/1-1-1.png`)
                    },
                    {
                        order: 2,
                        ...
                        captureImg: require(`/static/img/img_help/1.Login/1-1-2.png`)
                    },
                    {
                        order: 3,
                        procedure: <span><span style={{ color: "red" }}>{"\u2462"}</span> 인증메일 발송을 클릭합니다.</span>,
                        captureImg: require(`/static/img/img_help/1.Login/1-1-3.png`)
                    },
                    {
                        order: 4,
                        ...
                        captureImg: require(`/static/img/img_help/1.Login/1-1-4.png`)
                    }
                ]
            },
            {
                ...
                snameContents: [
                    {
                        order: 1,
                        procedure: <span>회원가입 시 작성하였던 아이디(e-mail)와 비밀번호를 입력하고. <span style={{ color: "red" }}>{"\u2460"}</span> 로그인 버튼을 클릭합니다.</span>,
                        captureImg: require(`/static/img/img_help/1.Login/1-2-1.png`)
                    }
                ]
            },
            {
                ...
                snameContents: [
                    {
                        ...
                        captureImg: require(`/static/img/img_help/1.Login/1-3-1.png`)
                    },
                    {
                        order: 2,
                        procedure: <span>회원가입 시 작성하였던 이름과 연락처를 작성후 찾기를 클릭합니다.<br></br>     {"\u279C"} <span style={{ color: "red" }}>{"\u2461"} </span>찾기를 클릭합니다.<br></br>     {"\u279C"} 가입 시 작성하였던 아이디(e-mail)를 확인할 수 있습니다.</span>,
                        captureImg: require(`/static/img/img_help/1.Login/1-3-2.png`)
                    }
                ]
            },
            {
                ...
                snameContents: [
                    {
                        ...
                        captureImg: require(`/static/img/img_help/1.Login/1-4-1.png`)
                    },
                    {
                        order: 2,
                        procedure: <span>아이디, 이름, 연락처를 작성 후 <span style={{ color: "red" }}>{"\u2461"}</span> 찾기를 클릭합니다.</span>,
                        captureImg: require(`/static/img/img_help/1.Login/1-4-2.png`)
                    },
                    {
                        order: 3,
                        procedure: <span>가입 시 작성한 아이디(e-mail)로 새 비밀번호가 전송 되었다는 메시지를 확인 후 <span style={{ color: "red" }}>{"\u2462"}</span> 확인을 클릭합니다.<br></br>     가입 시 작성한 아이디(e-mail)를 확인하여 새 비밀번호를 확인 할 수 있습니다.</span>,
                        captureImg: require(`/static/img/img_help/1.Login/1-4-3.png`)
                    }
                ]
            },
            {
                ...
                snameContents: [
                    {
                        ...
                        captureImg: require(`/static/img/img_help/1.Login/1-5-1.png`)
                    },
                ]
            }
        ]
                ...
                snameContents: [
                    {
                        ...
                        captureImg: require(`/static/img/img_help/2.Dashboard/2-1-0.png`)
                    }
                ]
            },
            {
                ...
                snameContents: [
                    {
                        ...
                        captureImg: require(`/static/img/img_help/2.Dashboard/2-1-1.png`)
                    }
                ]
            },
            {
                ...
                snameContents: [
                    {
                        ...
                        captureImg: require(`/static/img/img_help/2.Dashboard/2-1-2.png`)
                    },
                ]
            },
            {
                ...
                snameContents: [
                    {
                        ...
                        captureImg: require(`/static/img/img_help/2.Dashboard/2-1-3.png`)
                    },
                ]
            },
            {
                ...
                snameContents: [
                    {
                        ...
                        captureImg: require(`/static/img/img_help/2.Dashboard/2-1-4.png`)
                    },
                ]
            },
            {
                ...
                snameContents: [
                    {
                        ...
                        captureImg: require(`/static/img/img_help/2.Dashboard/2-1-5.png`)
                    },
                ]
            },
            {
                ...
                snameContents: [
                    {
                        ...
                        captureImg: require(`/static/img/img_help/2.Dashboard/2-1-6.png`)
                    },
                ]
            },
            {
                ...
                snameContents: [
                    {
                        ...
                        captureImg: require(`/static/img/img_help/2.Dashboard/2-1-7.png`)
                    },
                ]
            },
            {
                ...
                snameContents: [
                    {
                        ...
                        captureImg: require(`/static/img/img_help/2.Dashboard/2-1-8.png`)
                    },
                ]
            },
            {
                ...
                snameContents: [
                    {
                        ...
                        captureImg: require(`/static/img/img_help/2.Dashboard/2-1-9.png`)
                    },
                    {
                        order: 2,
                        procedure:
                        ...
                        captureImg: require(`/static/img/img_help/2.Dashboard/2-1-10.png`)
                    }
                ]
            },
            {
                ...
                snameContents: [
                    {
                        ...
                        captureImg: require(`/static/img/img_help/2.Dashboard/2-2-1-1.png`)
                    },
                    {
                        order: 2,
                        ...
                        captureImg: require(`/static/img/img_help/2.Dashboard/2-2-1-2.png`)
                    }
                ]
            },
            {
                ...
                snameContents: [
                    {
                        ...
                        captureImg: require(`/static/img/img_help/2.Dashboard/2-2-2-1.png`)
                    },
                    {
                        order: 2,
                        procedure: "로그아웃을 진행하여 해당 PC 또는 브라우저에서 로그인 유지 상태를 해제합니다.",
                        captureImg: require(`/static/img/img_help/2.Dashboard/2-2-2-2.png`)
                    }
                ]
            },
            {
                ...
                snameContents: [
                    {
                        ...
                        captureImg: require(`/static/img/img_help/2.Dashboard/2-3-1.png`)
                    },
                ]
            },
            {
                ...
                snameContents: [
                    {
                        order: 1,
                        procedure: <span><span style={{ color: "red" }}>{"\u2460"}</span> 한국어, 영어, 중국어로 되어있으며 선택된 언어로 사이트를 사용 가능합니다(<span style={{ color: "red" }}>모바일 미지원</span>).</span>,
                        captureImg: require(`/static/img/img_help/2.Dashboard/2-4-1.png`)
                    },
                ]
            }
        ]
                ...
                snameContents: [
                    {
                        ...
                        captureImg: require(`/static/img/img_help/3.e-Health Checker/3-1-0.png`)
                    }
                ]
            },
            {
                ...
                snameContents: [
                    {
                        ...
                        captureImg: require(`/static/img/img_help/3.e-Health Checker/3-1-1-1.png`)
                    },
                    {
                        order: 2,
                        procedure: <span><span style={{ color: "red" }}>{"\u2461"}</span> 화면 왼쪽 검색창에 검색어를 입력합니다.</span>,
                        captureImg: require(`/static/img/img_help/3.e-Health Checker/3-1-1-2.png`)
                    },
                    {
                        order: 3,
                        procedure: <span><span style={{ color: "red" }}>{"\u2462"}</span>검색 결과가 파란색으로 포커싱 되어 나타납니다</span>,
                        captureImg: require(`/static/img/img_help/3.e-Health Checker/3-1-1-3.png`)
                    }
                ]
            },
            {
                ...
                snameContents: [
                    {
                        ...
                        captureImg: require(`/static/img/img_help/3.e-Health Checker/3-1-2-1.png`)
                    },
                    {
                        order: 2,
                        procedure: <span><span style={{ color: "red" }}>{"\u2461"}</span> 설정 버튼을 눌러 점검주기 변경이 가능합니다.
                            <br></br>     <span style={{ color: "red" }}>{"\u2462"}</span> 점검주기는 30일, 90일 180일, 365일로 조회가 가능합니다.</span>,
                        captureImg: require(`/static/img/img_help/3.e-Health Checker/3-1-2-2.png`)
                    }
                ]
            },
            {
                ...
                snameContents: [
                    {
                        ...
                        captureImg: require(`/static/img/img_help/3.e-Health Checker/3-1-3-1.png`)
                    },
                    {
                        order: 2,
                        procedure: <span>
                        ...
                        captureImg: require(`/static/img/img_help/3.e-Health Checker/3-1-3-2.png`)
                    },
                ]
            },
            {
                ...
                snameContents: [
                    {
                        ...
                        captureImg: require(`/static/img/img_help/3.e-Health Checker/3-1-4-1.png`)
                    },
                    {
                        order: 2,
                        procedure: <span>점검 진행 버튼을 클릭하여 진단점검이 가능합니다.
                            <br></br>     {"\u279C"} <span style={{ color: "red" }}>{"\u2461"}</span> 각 점검 항목은 기기, 점검 상태 마다 다릅니다.</span>,
                        captureImg: require(`/static/img/img_help/3.e-Health Checker/3-1-4-2.png`)
                    },
                    {
                        order: 3,
                        ...
                        captureImg: require(`/static/img/img_help/3.e-Health Checker/3-1-4-3.png`)
                    },
                    {
                        order: 4,
                        ...
                        captureImg: require(`/static/img/img_help/3.e-Health Checker/3-1-4-4.png`)
                    }
                ]
            },
            /* {
                ...
                snameContents: [
                    {
                        ...
                        captureImg: require(`/static/img/img_help/3.e-Health Checker/3-1-4-5.png`)
                    },
                    {
                        order: 2,
                        procedure: "진단점검(VCB 예시)",
                        captureImg: require(`/static/img/img_help/3.e-Health Checker/3-1-4-6.png`)
                    },
                    {
                        order: 3,
                        procedure: "진단점검(VCB 예시)",
                        captureImg: require(`/static/img/img_help/3.e-Health Checker/3-1-4-7.png`)
                    }
                ]
            },
            {
                ...
                snameContents: [
                    {
                        ...
                        captureImg: require(`/static/img/img_help/3.e-Health Checker/3-2-0.png`)
                    }
                ]
            },
            {
                ...
                snameContents: [
                    {
                        ...
                        captureImg: require(`/static/img/img_help/3.e-Health Checker/3-2-1.png`)
                    },
                ]
            },
            {
                ...
                snameContents: [
                    {
                        ...
                        captureImg: require(`/static/img/img_help/3.e-Health Checker/3-2-2.png`)
                    },
                ]
            },
            {
                ...
                snameContents: [
                    {
                        ...
                        captureImg: require(`/static/img/img_help/3.e-Health Checker/3-2-3.png`)
                    },
                ]
            }
        ]
                ...
                snameContents: [
                    {
                        ...
                        captureImg: require(`/static/img/img_help/4.Device registration status/4-1-0.png`)
                    }
                ]
            },
            {
                ...
                snameContents: [
                    {
                        ...
                        captureImg: require(`/static/img/img_help/4.Device registration status/4-1-1-1.png`)
                    },
                    {
                        order: 2,
                        ...
                        captureImg: require(`/static/img/img_help/4.Device registration status/4-1-1-2.png`)
                    },
                    {
                        order: 3,
                        procedure: <span>검색은 모델 명, 시리얼 번호로 <span style={{ color: "red" }}>{"\u2462"}</span>을 클릭하여 조회가 가능합니다.</span>,
                        captureImg: require(`/static/img/img_help/4.Device registration status/4-1-1-3.png`)
                    }
                ]
            },
            {
                ...
                snameContents: [
                    {
                        ...
                        captureImg: require(`/static/img/img_help/4.Device registration status/4-1-2.png`)
                    }
                ]
            },
            {
                ...
                snameContents: [
                    {
                        order: 1,
                        procedure: <span>
                            <span style={{ color: "red" }}>{"\u2460"}</span> 다운로드가 가능합니다.
                            <br></br>     {"\u279C"}모바일은 상세보기에서 다운로드가 가능합니다.
                            <br></br>     <span style={{ color: "red" }}>{"\u2461"}</span> 클립 모양 아이콘 클릭 시 PDF 바로 가기가 가능합니다.
                            <br></br>     {"\u279C"} 바로가기 내에서 다운로드가 가능합니다.
                        </span>,
                        captureImg: require(`/static/img/img_help/4.Device registration status/4-1-3-1.png`)
                    },
                    {
                        order: 2,
                        procedure: <span><span style={{ color: "red" }}>{"\u2461"}</span> 선택된 Report에 대해 일괄다운로드(압축파일)을 제공합니다. (모바일 제외)</span>,
                        captureImg: require(`/static/img/img_help/4.Device registration status/4-1-3-2.png`)
                    }
                ]
            },
            {
                ...
                snameContents: [
                    {
                        ...
                        captureImg: require(`/static/img/img_help/4.Device registration status/4-1-4-1.png`)
                    },
                    {
                        order: 2,
                        procedure: <span>진단결과 Report를 다른 사용자에게 <span style={{ color: "red" }}>{"\u2461"}</span> 이메일로 공유 할 수 있습니다.</span>,
                        captureImg: require(`/static/img/img_help/4.Device registration status/4-1-4-2.png`)
                    },
                ]
            },
            {
                ...
                snameContents: [
                    {
                        ...
                        captureImg: require(`/static/img/img_help/4.Device registration status/4-2-0.png`)
                    }
                ]
            },
            {
                ...
                snameContents: [
                    {
                        order: 1,
                        procedure: <span>
                            <span style={{ color: "red" }}>{"\u2460"}</span> Filter는 기기유형(전체, 배전반, 유입식TR, ACB, GIS, MoldTR, VCB)로 조회가 가능합니다.
                            <br></br>          검색은 모델 명, 시리얼 번호로 <span style={{ color: "red" }}>{"\u2461"}</span> 조회가 가능합니다.
                        </span>,
                        captureImg: require(`/static/img/img_help/4.Device registration status/4-2-1-1.png`)
                    },
                    {
                        order: 2,
                        ...
                        captureImg: require(`/static/img/img_help/4.Device registration status/4-2-1-2.png`)
                    },
                    {
                        order: 3,
                        procedure: <span><span style={{ color: "red" }}>{"\u2464"}</span> 시리얼 번호 버튼 클릭 시 팝업 화면. <span style={{ color: "red" }}>{"\u2465"}</span> QR 버튼 클릭 시 팝업 화면
                        </span>,
                        captureImg: require(`/static/img/img_help/4.Device registration status/4-2-1-3.png`)
                    }
                ]
            },
            {
                ...
                snameContents: [
                    {
                        ...
                        procedure: <span>
                            ...
                            <br></br>     <span style={{ color: "red" }}>{"\u2461"}</span> 선택된 성적서에 대해 일괄다운로드 (압축파일)을 제공합니다. (모바일 제외)</span>,
                        captureImg: require(`/static/img/img_help/4.Device registration status/4-2-2-1.png`)
                    }
                ]
            }
        ]
        ...
        "subMenu": [
            {
                ...
                snameContents: [
                    {
                        order: 1,
                        procedure: <span>e-Health Check 서비스의 3단계 진단점검 결과를 바탕으로 LS ELCTRIC 전문가의 지원을 통하여 설비수명 인자를 설정하는 기능을 제공(<span style={{ color: "red" }}>모바일은 미지원</span>).</span>,
                        captureImg: require(`/static/img/img_help/5.Diagnostic Check Report/5-1-0.png`)
                    }
                ]
            },
            {
                ...
                snameContents: [
                    {
                        ...
                        procedure:
                            <span>
                                ...
                                <br></br>     <span style={{ color: "red" }}>{"\u2461"}</span> 검색을 사용하여 조회가 가능합니다.
                                <br></br>     {"\u279C"} 검색 조건은 기기 명, 패널 명, 시리얼 번호, 모델 명으로 조회가 가능합니다.
                                (<span style={{ color: "red" }}>모바일은 미지원</span>)
                            </span>,
                        captureImg: require(`/static/img/img_help/5.Diagnostic Check Report/5-1-1.png`)
                    }
                ]
            },
            {
                ...
                snameContents: [
                    {
                        ...
                        procedure:
                            <span>
                                ...
                                <span style={{ color: "red" }}>{"\u2462"}</span> 저장 할 수 있습니다(<span style={{ color: "red" }}>모바일은 미지원</span>).
                            </span>
                        ,
                        captureImg: require(`/static/img/img_help/5.Diagnostic Check Report/5-1-2-1.png`)
                    },
                    {
                        order: 2,
                        procedure:
                            <span>
                                수명인자 설정이 가능합니다.
                                <br></br>          {"\u279C"} 목록 중 기기를 클릭하여 설정 항목으로 들어 갈 수 있습니다.
                                <br></br>          {"\u279C"} <span style={{ color: "red" }}>{"\u2461"}</span> 설정 항목에서 스크롤을 내리면 User Defined 곳에 사용자가 항목을 새롭게 추가 할 수 있습니다(<span style={{ color: "red" }}>모바일은 미지원</span>).
                            </span>
                        ,
                        captureImg: require(`/static/img/img_help/5.Diagnostic Check Report/5-1-2-2.png`)
                    }
                ]
            },
            {
                ...
                snameContents: [
                    {
                        ...
                        captureImg: require(`/static/img/img_help/5.Diagnostic Check Report/5-2-0.png`)
                    }
                ]
            }
        ]
                ...
                snameContents: [
                    {
                        ...
                        captureImg: require(`/static/img/img_help/6.Operations Management/6-1-0.png`)
                    }
                ]
            },
            {
                ...
                snameContents: [
                    {
                        ...
                        captureImg: require(`/static/img/img_help/6.Operations Management/6-1-1.png`)
                    },
                ]
            },
            {//사용자만 보임
                sid: 3,
                sname: "사업장 전기실 관리 - 사업장 추가",
                snameContents: [
                    {
                        order: 1,
                        procedure: <span>사용자는 사업장을 추가요청 두 가지 방법으로 할 수 있습니다.
                            <br></br>          {"\u279C"} 사업장 검색 추가, 사업장 신규등록 추가가 있습니다.
                        </span>,
                        captureImg: require(`/static/img/img_help/6.Operations Management/u_6-1-1-1.png`)
                    }
                ]
            },
            {//사용자만 보임 
                ...
                snameContents: [
                    {
                        ...
                        captureImg: require(`/static/img/img_help/6.Operations Management/u_6-1-1-2.png`)
                    },
                    {
                        order: 2,
                        procedure: "사업장 추가 시 사업장 요청으로 왼쪽 트리 창에 추가가 됩니다.",
                        captureImg: require(`/static/img/img_help/6.Operations Management/u_6-1-1-3.png`)
                    }
                ]
            },
            {//사용자만 보임
                ...
                snameContents: [
                    {
                        ...
                        captureImg: require(`/static/img/img_help/6.Operations Management/u_6-1-1-4.png`)
                    },
                    {
                        order: 2,
                        procedure: "사용자가 사업장 이미지, 사업장 명, 사업장 주소, 메모 정보 입력을 하여 추가 요청 및 저장을 할 수 있습니다.",
                        captureImg: require(`/static/img/img_help/6.Operations Management/u_6-1-1-5.png`)
                    }
                ]
            },
            {//사용자만 보임
                ...
                snameContents: [
                    {
                        ...
                        captureImg: require(`/static/img/img_help/6.Operations Management/u_6-1-2-1.png`)
                    }
                ]
            },
            {
                ...
                snameContents: [
                    {
                        ...
                        procedure:
                            <span>
                                <span style={{ color: "red" }}>{"\u2460"}</span> 우측 수정 아이콘을 클릭하여 상세 사업장을 수정 할 수 있습니다.
                            </span>,
                        captureImg: require(`/static/img/img_help/6.Operations Management/6-1-2-1.png`)
                    },
                    {
                        order: 2,
                        procedure:
                        ...
                        captureImg: require(`/static/img/img_help/6.Operations Management/6-1-2-2.png`)
                    }
                ]
            },
            {//사용자만 보임
                ...
                snameContents: [
                    {
                        ...
                        captureImg: require(`/static/img/img_help/6.Operations Management/u_6-1-2-2.png`)
                    },
                    {
                        order: 2,
                        procedure:
                        ...
                        captureImg: require(`/static/img/img_help/6.Operations Management/u_6-1-2-3.png`)
                    }
                ]
            },
            {//사용자만 보임
                ...
                snameContents: [
                    {
                        ...
                        captureImg: require(`/static/img/img_help/6.Operations Management/u_6-1-2-4.png`)
                    }
                ]
            },
            {
                ...
                snameContents: [
                    {
                        ...
                        captureImg: require(`/static/img/img_help/6.Operations Management/6-1-2-3.png`)
                    }
                ]
            },
            {
                ...
                snameContents: [
                    {
                        ...
                        procedure: <span>
                            햄버거 메뉴에서 ‘운영관리 {"\u279C"} 기기 등록 관리’ 를 클릭하여 사업장 전기실 관리화면으로 이동합니다.
                            <br></br>     <span style={{ color: "red" }}>{"\u2460"}</span> 좌측 트리에서 LS ELECTRIC 청주 {"\u279C"} 2사업장 을 선택 후 ‘신규 전기실 추가’를 클릭하여 화면 이동합니다.
                        </span>,
                        captureImg: require(`/static/img/img_help/6.Operations Management/6-1-3-1.png`)
                    },
                    {
                        order: 2,
                        procedure: <span>
                        ...
                        captureImg: require(`/static/img/img_help/6.Operations Management/6-1-3-2.png`)
                    }
                ]
            },
            {
                ...
                snameContents: [
                    {
                        ...
                        captureImg: require(`/static/img/img_help/6.Operations Management/6-1-3-3.png`)
                    },
                    {
                        order: 2,
                        procedure: <span>
                        ...
                        captureImg: require(`/static/img/img_help/6.Operations Management/6-1-3-4.png`)
                    }
                ]
            },
            {//사용자만 보임
                ...
                snameContents: [
                    {
                        ...
                        captureImg: require(`/static/img/img_help/6.Operations Management/u_6-1-3-3.png`)
                    },
                    {
                        order: 2,
                        procedure: <span>
                        ...
                        captureImg: require(`/static/img/img_help/6.Operations Management/u_6-1-3-4.png`)
                    }
                ]
            },
            {
                ...
                snameContents: [
                    {
                        ...
                        captureImg: require(`/static/img/img_help/6.Operations Management/6-1-3-5.png`)
                    }
                ]
            },
            {//사용자만 보임
                ...
                snameContents: [
                    {
                        ...
                        captureImg: require(`/static/img/img_help/6.Operations Management/u_6-1-3-5.png`)
                    }
                ]
            },
            {
                ...
                snameContents: [
                    {
                        ...
                        captureImg: require(`/static/img/img_help/6.Operations Management/6-2-0.png`)
                    }
                ]
            },
            {
                ...
                snameContents: [
                    {
                        ...
                        captureImg: require(`/static/img/img_help/6.Operations Management/6-2-1.png`)
                    }
                ]
            },
            {
                ...
                snameContents: [
                    {
                        ...
                        procedure: <span>
                            ...
                            <br></br>     <span style={{ color: "red" }}>{"\u2463"}</span> 일괄 등록한 결과를 확인합니다(<span style={{ color: "red" }}>모바일 미지원</span>).
                        </span>,
                        captureImg: require(`/static/img/img_help/6.Operations Management/6-2-2-1.png`)
                    }
                ]
            },
            {
                sid: 19,
                sname: "(기기 일괄등록)엑셀 양식 설명",
                snameContents: [
                    {
                        order: 1,
                        procedure: "엑셀 양식 설명",
                        captureImg: require(`/static/img/img_help/6.Operations Management/6-2-2-2.png`)
                    }
                ]
            },
            {
                ...
                snameContents: [
                    {
                        ...
                        captureImg: require(`/static/img/img_help/6.Operations Management/6-2-3.png`)
                    }
                ]
            },
            {
                ...
                snameContents: [
                    {
                        ...
                        captureImg: require(`/static/img/img_help/6.Operations Management/6-2-4.png`)
                    }
                ]
            },
            {
                ...
                snameContents: [
                    {
                        ...
                        captureImg: require(`/static/img/img_help/6.Operations Management/6-2-5.png`)
                    }
                ]
            },
            {
                ...
                snameContents: [
                    {
                        ...
                        captureImg: require(`/static/img/img_help/6.Operations Management/6-2-6.png`)
                    }
                ]
            },
            {
                ...
                snameContents: [
                    {
                        ...
                        captureImg: require(`/static/img/img_help/6.Operations Management/6-2-7.png`)
                    }
                ]
            },
            {
                ...
                snameContents: [
                    {
                        ...
                        captureImg: require(`/static/img/img_help/6.Operations Management/6-2-8.png`)
                    }
                ]
            }
        ]
                ...
                snameContents: [
                    {
                        ...
                        captureImg: require(`/static/img/img_help/7.Management/7-1-0.png`)
                    }
                ]
            },
            {
                ...
                snameContents: [
                    {
                        ...
                        captureImg: require(`/static/img/img_help/7.Management/7-1-1-1.png`)
                    },
                    {
                        order: 2,
                        procedure: <span><span style={{ color: "red" }}>{"\u2461"}</span> 신규 가입자의 정보를 확인하고 승인 여부(승인, 반려), 사용자 타입(Admin, Engineer, User)을 정할 수 있습니다.
                            <br></br>          {"\u279C"}사용자 타입 지정 시 Admin, Engineer는 추가가 안 됩니다.
                            <br></br>          {"\u279C"}사용자 타입 지정 시 User는 회사_사업장 목록이 추가 할 수 있습니다.</span>,
                        captureImg: require(`/static/img/img_help/7.Management/7-1-1-2.png`)
                    },
                    {
                        order: 3,
                        ...
                        captureImg: require(`/static/img/img_help/7.Management/7-1-1-3.png`)
                    },
                    {
                        order: 4,
                        procedure: <span><span style={{ color: "red" }}>{"\u2463"}</span> 회사-사업장 추가 시 회사와 사업장을 추가하여 등록합니다.</span>,
                        captureImg: require(`/static/img/img_help/7.Management/7-1-1-4.png`)
                    }
                ]
            },
            {
                ...
                snameContents: [
                    {
                        ...
                        captureImg: require(`/static/img/img_help/7.Management/7-1-2-1.png`)
                    },
                    {
                        order: 2,
                        procedure: <span><span style={{ color: "red" }}>{"\u2461"}</span>
                            사용자가 요청한 사업장의 정보를 확인하고 승인 여부(승인, 반려)을 확인 할 수 있습니다.</span>,
                        captureImg: require(`/static/img/img_help/7.Management/7-1-2-2.png`)
                    },
                    {
                        order: 3,
                        procedure: <span><span style={{ color: "red" }}>{"\u2462"}</span> 수정 아이콘을 클릭하여 사용자가 요청한 사업장의 정보를 수정 할 수 있습니다.</span>,
                        captureImg: require(`/static/img/img_help/7.Management/7-1-2-3.png`)
                    },
                    {
                        order: 4,
                        procedure: <span><span style={{ color: "red" }}>{"\u2463"}
                        </span> 사업장 명, 메모를 수정하여 저장을 합니다.</span>,
                        captureImg: require(`/static/img/img_help/7.Management/7-1-2-4.png`)
                    }
                ]
            },
            {
                ...
                snameContents: [
                    {
                        ...
                        captureImg: require(`/static/img/img_help/7.Management/7-1-3-1.png`)
                    },
                    {
                        order: 2,
                        procedure: <span>
                        ...
                        captureImg: require(`/static/img/img_help/7.Management/7-1-3-2.png`)
                    }
                ]
            },
            {
                ...
                snameContents: [
                    {
                        ...
                        captureImg: require(`/static/img/img_help/7.Management/7-2-0.png`)
                    }
                ]
            },
            {
                ...
                snameContents: [
                    {
                        ...
                        captureImg: require(`/static/img/img_help/7.Management/7-2-1.png`)
                    }
                ]
            },
            {
                ...
                snameContents: [
                    {
                        ...
                        captureImg: require(`/static/img/img_help/7.Management/7-2-2.png`)
                    }
                ]
            },
            {
                ...
                snameContents: [
                    {
                        ...
                        captureImg: require(`/static/img/img_help/7.Management/7-3-0.png`)
                    }
                ]
            },
            {
                ...
                snameContents: [
                    {
                        ...
                        captureImg: require(`/static/img/img_help/7.Management/7-3-1.png`)
                    }
                ]
            },
            {
                ...
                snameContents: [
                    {
                        ...
                        captureImg: require(`/static/img/img_help/7.Management/7-3-2.png`)
                    }
                ]
            },
            {
                ...
                snameContents: [
                    {
                        ...
                        captureImg: require(`/static/img/img_help/7.Management/7-3-3.png`)
                    }
                ]
            },
            {
                ...
                snameContents: [
                    {
                        ...
                        captureImg: require(`/static/img/img_help/7.Management/7-3-4.png`)
                    }
                ]
            },
            {
                ...
                snameContents: [
                    {
                        ...
                        captureImg: require(`/static/img/img_help/7.Management/7-4-0.png`)
                    },
                    {
                        order: 2,
                        procedure: "e-Health Checker 메시지, 에러 메시지, HTTP 메시지, 알람 메시지 4가지 종류가 있습니다.\n     목록을 확인하고 추가/삭제가 가능합니다.",
                        captureImg: require(`/static/img/img_help/7.Management/7-4-1-1.png`)
                    },
                    {
                        order: 3,
                        procedure: "메시지 추가 시 이름과 종류를 추가 할 수 있고, 언어별의 따라 메시지를 추가 할 수 있습니다.",
                        captureImg: require(`/static/img/img_help/7.Management/7-4-1-2.png`)
                    }
                ]
            },
            {
                ...
                snameContents: [
                    {
                        ...
                        captureImg: require(`/static/img/img_help/7.Management/7-5-0.png`)
                    },
                    {
                        order: 2,
                        procedure: <span>
                        ...
                        captureImg: require(`/static/img/img_help/7.Management/7-5-1.png`)
                    },
                    {
                        order: 3,
                        procedure: <span>
                        ...
                        captureImg: require(`/static/img/img_help/7.Management/7-5-2.png`)
                    }
                ]
            },
            {
                ...
                snameContents: [
                    {
                        order: 1,
                        procedure: "e-Health Check 서비스에서 제공하는 3단계 진단점검 항목의 버전 및 다국어 관리를 할 수 있습니다.",
                        captureImg: require(`/static/img/img_help/7.Management/7-6-0.png`)
                    }
                ]
            },
            {
                ...
                snameContents: [
                    {
                        ...
                        captureImg: require(`/static/img/img_help/7.Management/7-6-1.png`)
                    }
                ]
            },
            {
                ...
                snameContents: [
                    {
                        ...
                        captureImg: require(`/static/img/img_help/7.Management/7-6-2-1.png`)
                    },
                    {
                        order: 2,
                        procedure: <span>
                        ...
                        captureImg: require(`/static/img/img_help/7.Management/7-6-2-2.png`)
                    }
                ]
            },
            {
                ...
                snameContents: [
                    {
                        ...
                        captureImg: require(`/static/img/img_help/7.Management/7-6-3.png`)
                    }
                ]
            },
            {
                ...
                snameContents: [
                    {
                        ...
                        captureImg: require(`/static/img/img_help/7.Management/7-7-0.png`)
                    }
                ]
            },
            {
                ...
                snameContents: [
                    {
                        ...
                        captureImg: require(`/static/img/img_help/7.Management/7-7-1.png`)
                    }
                ]
            },
            {
                ...
                snameContents: [
                    {
                        ...
                        captureImg: require(`/static/img/img_help/7.Management/7-7-2.png`)
                    }
                ]
            },
            {
                ...
                snameContents: [
                    {
                        ...
                        captureImg: require(`/static/img/img_help/7.Management/7-7-3.png`)
                    }
                ]
            },
            {
                ...
                snameContents: [
                    {
                        ...
                        captureImg: require(`/static/img/img_help/7.Management/7-7-4.png`)
                    }
                ]
            }
        ]
                ...
                snameContents: [
                    {
                        ...
                        captureImg: require(`/static/img/img_help/8.Service Introduce/8-1-0.png`)
                    },
                    {
                        order: 2,
                        procedure: "e-Health Portal의 대표적인 기능인 대시보드, 진단점검, 운영관리, Report, 점검출동 등을 둘러볼 수 있습니다.",
                        captureImg: require(`/static/img/img_help/8.Service Introduce/8-1-1.png`)
                    }
                ]
            },
            {
                ...
                snameContents: [
                    {
                        ...
                        captureImg: require(`/static/img/img_help/8.Service Introduce/8-2-0.png`)
                    },
                    {
                        order: 2,
                        procedure: "e-Health Portal 주요 서비스인 메인대시보드, e-Health Check, Report, 설비수명, 운영관리, 점검이력/요청, 포탈 사용자에 대한 내용을 확인할 수 있습니다.",
                        captureImg: require(`/static/img/img_help/8.Service Introduce/8-2-1.png`)
                    }
                ]
            },
            {
                ...
                snameContents: [
                    {
                        ...
                        captureImg: require(`/static/img/img_help/8.Service Introduce/8-3-0.png`)
                    },
                    {
                        order: 2,
                        procedure: "좌측 목차 메뉴를 선택하면, 해당 도움말을 확인할 수 있습니다.",
                        captureImg: require(`/static/img/img_help/8.Service Introduce/8-3-1.png`)
                    }
                ]
            }
        ]
                ...
                snameContents: [
                    {
                        ...
                        captureImg: require(`/static/img/img_help/9.Service Request/9-1-0.png`)
                    }
                ]
            },
            {
                ...
                snameContents: [
                    {
                        ...
                        captureImg: require(`/static/img/img_help/9.Service Request/9-1-1.png`)
                    }
                ]
            },
            {
                ...
                snameContents: [
                    {
                        ...
                        captureImg: require(`/static/img/img_help/9.Service Request/9-2-0.png`)
                    }
                ]
            },
            {
                ...
                snameContents: [
                    {
                        ...
                        captureImg: require(`/static/img/img_help/9.Service Request/9-2-1-1.png`)
                    },
                    {
                        order: 2,
                        procedure: <span>
                        ...
                        captureImg: require(`/static/img/img_help/9.Service Request/9-2-1-2.png`)
                    }
                ]
            },
            {
                ...
                snameContents: [
                    {
                        ...
                        captureImg: require(`/static/img/img_help/9.Service Request/9-2-2.png`)
                    }
                ]
            },
            {
                ...
                snameContents: [
                    {
                        order: 1,
                        procedure: <span><span style={{ color: "red" }}>{"\u2460"}</span> 점검 및 사고이력을 상태별로 검색이 가능하고 목록을 조회 할 수 있습니다.
                            <br></br>          {"\u279C"} 상태는 전체, 요청, 접수, 진행중, 완료가 있습니다.
                            <br></br>     <span style={{ color: "red" }}>{"\u2461"}</span> 요청 일자 조회가 가능합니다.
                            <br></br>          {"\u279C"} 일자는 전체, 1개월, 3개월, 6개월 1년이 있습니다.
                            <br></br>     <span style={{ color: "red" }}>{"\u2462"}</span> 검색 조건 검색이 가능합니다.
                            <br></br>          {"\u279C"}조건은 기기 명, 불량원인, 불량처리, 시리얼 번호, 모델 명으로 조회가 가능합니다.
                        </span>,
                        captureImg: require(`/static/img/img_help/9.Service Request/9-2-3.png`)
                    }
                ]
            },
            {
                ...
                snameContents: [
                    {
                        order: 1,
                        procedure: <span>
                            <span style={{ color: "red" }}>{"\u2460"}</span> 사업장 및 상세 사업장 선택 후 <span style={{ color: "red" }}>{"\u2461"}</span> 노후교체 상태의 따라 요청 목록 조회가 가능합니다.
                            <br></br>          {"\u279C"} 상태는 전체, 요청, 접수가 있습니다.
                            <br></br>     <span style={{ color: "red" }}>{"\u2462"}</span> 요청 일자 조회가 가능합니다.
                            <br></br>          {"\u279C"} 일자는 전체, 1개월, 3개월, 6개월 1년이 있습니다.
                            <br></br>     <span style={{ color: "red" }}>{"\u2463"}</span> 검색 조건 검색이 가능합니다.
                            <br></br>          {"\u279C"} 조건은 기기 명, 패널 명, 시리얼 번호, 모델 명으로 조회가 가능합니다.
                        </span>,
                        captureImg: require(`/static/img/img_help/9.Service Request/9-2-4.png`)
                    }
                ]
            },
            {
                ...
                snameContents: [
                    {
                        order: 1,
                        procedure: "e-Health Portal 웹사이트 사용 및 기타 문의내용을 이메일 상담하는 기능을 제공합니다.",
                        captureImg: require(`/static/img/img_help/9.Service Request/9-3-0.png`)
                    }
                ]
            },
            {
                ...
                snameContents: [
                    {
                        ...
                        captureImg: require(`/static/img/img_help/9.Service Request/9-3-1-1.png`)
                    }
                ]
            },
            {
                ...
                snameContents: [
                    {
                        ...
                        captureImg: require(`/static/img/img_help/9.Service Request/9-3-2-1.png`)
                    },
                    {
                        order: 2,
                        procedure: <span>LS Electric 서비스 센터를 찾아 볼 수 있습니다.</span>,
                        captureImg: require(`/static/img/img_help/9.Service Request/9-3-2-2.png`)
                    }
                ]
            },
            {
                ...
                snameContents: [
                    {
                        ...
                        captureImg: require(`/static/img/img_help/9.Service Request/9-3-3-1.png`)
                    },
                    {
                        order: 2,
                        procedure: <span>LS Electric 업무에 대한 문의를 챗봇을 통해 빠르게 안내를 받을 수 있습니다.</span>,
                        captureImg: require(`/static/img/img_help/9.Service Request/9-3-3-2.png`)
                    }
                ]
            }
        ]
