...
function CompanyInsert(props) {
  ...
  async function onClickDoSaveCompany(e) {
    let data: any = null;
  ...
  function onClickDoCancelCompany(e) {
    setParentSelTree("COMPANY",
    { ...selTree, 
      ...
      <ul className="form__input">
        ...
        <li>
          <div className="btn__wrap right w100p">
            <button type="button" 
              className="bg-gray"
              onClick={(e)=>onClickDoCancelCompany(e)}
            >
              <span>취소</span>
            </button>
            <button type="button"
              onClick={(e)=>onClickDoSaveCompany(e)}
            >
              <span>저장</span>
            </button>
          </div>
