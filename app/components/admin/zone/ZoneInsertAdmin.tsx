...
//component
function ZoneInsertAdmin(props) {
  //recoil
  ...
  useEffect(()=>{
    if ( retList ) {
      if (retList.codeNum == CONST.API_200) {
        ...
        setErrorList(retList.data.errorList);        
      }
    }
  }, [retList])
  ...
  // comment 길이 제한 콜백 함수
  function callbackSetZoneInfoMemo(callbackmemo) {
    setZoneInfo({...zoneInfo, memo:callbackmemo});
  }
  ...
  function onClickCompZoneAdminInsert(e) {
    setParentWorkMode("ADMIN_COMP_CREATE");
  }
  ...
  useEffect(()=>{
    setParentPopWin("pop-area-rigth", 
      <MobileZoneInsertAdmin 
        ...
        //action button
        onClickCompZoneAdminInsert={onClickCompZoneAdminInsert}
  ...
  <div className="area__right" ref={mobileRef}>
    ...
    <ul className="tab__small">
      {/*<!-- 선택된 탭 on */}
      <li className="on"><a href="#" className="icon-pen">사업장</a></li>
      <li><a href="#" className="icon-pen" onClick={(e)=>onClickCompZoneAdminInsert(e)}>회사/사업장</a></li>
    </ul>
      ...
      <div className="content__info">
        ...
        <ul className="form__input">
          ...
          <li>
            ...
            <div className="input__area">
              <input type="text" value={companyInfo.administrator} disabled />
          ...
          <li>
            ...
            <div className="input__area">
              <input type="text" value={companyInfo.classification} disabled />
          ...
          <li>
            ...
            <div className="input__area">
              <input type="text" value={companyInfo.accountManager} disabled />
              {/*<div className="box__search">
                <input type="text" placeholder="직접입력" />
                <button type="button" className="btn btn-search"><span className="hide">조회</span></button>
            </div>*/}
          ...
          <li>
            ...
            <div className="input__area">
              <input type="text" value={companyInfo.accMngrTelephone} disabled />
          ...
          <li>
            ...
            <div className="input__area">
              <input type="text" value={companyInfo.interfaceInfo} disabled />
          ...
          <li>
            ...
            <div className="input__area">
              <textarea placeholder="메모를 입력하세요" value={companyInfo.memo} disabled>{companyInfo.memo}</textarea>
...
export default ZoneInsertAdmin;


function MobileZoneInsertAdmin(props) {
  ...
  //
  const onClickCompZoneAdminInsert = props.onClickCompZoneAdminInsert;
  ...
  <div className="popup__body">
    ...
    <div className="area__right" id="pop-area-right">
      ...
      <div className="area__right_content workplace__info workplace__main info__input newtype">
        ...
        <div className="btn__wrap center">
          <button type="button" 
            className="bg-gray btn-close js-close" 
