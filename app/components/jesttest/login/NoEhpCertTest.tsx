...
function NoEhpCertification() {
    ...
    function reCertifiacation(e) {
        //CUTIL.jsopen_Popup(e)

        var logCertifications = document.getElementById("certification");

        if (!CUTIL.isnull(logCertifications)) logCertifications.click();
                ...
                <div className="login__form">
                    <form action="#" method="" name="loginform">
                        <fieldset>
                            ...
                            <button type="button" className="btn-login js-open" data-pop={"join-ok"} onClick={reCertifiacation}><span>인증하기</span></button>
                        </fieldset>
                    </form>
                </div>
            </div>
            <div id="join-ok" className="popup-layer js-layer layer-out hidden w560 login__popup">
                ...
                <div className="popup__body joinok-h webmail">
                    <div className="complete-txt">
                        ...
                        <button id="certification" type="button"><span>인증메일 재발송1</span></button>
