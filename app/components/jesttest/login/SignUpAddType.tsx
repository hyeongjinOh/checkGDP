                            ...
                            <li>
                                ...
                                <div className="input__area">
                                    <div className={`select ${(errorList.filter(err => (err.field === "classificationId")).length > 0) ? "input-error" : ""}`}
                                        ...
                                        <div className="selected">
                                            <div className="selected-value">제조업</div>
                                            <div className="arrow"></div>
                                        </div>
                                        <ul>
                    ...
                    <ul className="terms">
                        <li>
                            ...
                            <div className="box-scroll">
                                ...
                                <p className="txt">이 약관은 LS ELECTRIC(이하 "회사") e-Health Checker 시스템에서 제공하는 모든 서비스의 이용조건 및 절차에 관한 사항과 기타 필요한 사항을 전기통신사업법 및 동법 시행령이 정하는 대로 준수하고 규정함을 목적으로 합니다.</p>
                                ...
                                <p className="txt">
                                    ...
                                    "비회원"이라 함은 회원에 가입하지 않고 e-Health Checker 시스템에서 제공하는 서비스를 이용하는 자를 말합니다.
                                </p>
                                <p className="tit-middle">제 3조 약관의 효력과 변경</p>
                                <p className="txt">
                                    이 약관은 회사 e-Health Checker 시스템의 초기 서비스 화면에 이용자에게 공시함으로써 효력이 발생합니다. 회사는 사정 변경의 경우와 영업상 중요 사유가 있을 때 약관의 규제 등에 관한 법률 등 관련법을 위반하지 않는 범위에서 이 약관을 변경할 수 있으며, 이 경우에는 적용일자 및 개정사유,
                                ...
                                <p className="txt">
                                    회사 e-Health Checker 시스템상 서비스 이용 계약은 이용자가 회원 가입에 따른 서비스 이용 신청에 대한 회사의 이용 승낙과 이용자의 이 약관에 동의한다는 의사표시로 성립됩니다. 이용자가 회원에 가입하여 회사 e-Health Checker 시스템상 서비스를 이용하고자 하는 경우, 회원은 회사에서 요청하는
                                    개인 신상정보를 제공해야 합니다. 이용자의 회사 e-Health Checker 시스템상 서비스 이용신청에 대하여 회사가 승낙한 경우, 회사는 회원 이메일과 기타 회사가 필요하다고 인정하는 내용을 이용자에게 통지합니다.
                                </p>
                                ...
                                <p className="txt">
                                    회사 e-Health Checker 시스템상 서비스 이용은 회사의 업무상 또는 기술상 특별한 지장이 없는 한 연중무휴, 1일 24시간을 원칙으로 합니다. 전항의 서비스 이용시간은 정보통신 시스템 등 정기점검/교체 등 e-Health Checker가 필요한 경우, 회원에게 사전 통지한 후, 제한할 수 있습니다. 서비스 중단의
                                    경우에는 회사는 회원이 회사e-Health Checker 시스템에 제출한 전자우편 주소로 개별 통지하거나, 불특정다수 회원에 대하여는 1주일 이상 게시판에 게시함으로써 개별 통지에 갈음할 수 있습니다.
                                </p>
                                ...
                                <p className="txt mt-10">
                                    1. 신청 또는 변경 시 허위내용의 등록<br />2. 회사 e-Health Checker 시스템이 정한 정보 이외의 정보(컴퓨터 프로그램 등)의 송신 또는 게시<br />3. 회사 e-Health Checker 시스템 기타 제3자의 저작권 등 지적재산권에 대한 침해<br />4. 회사 기타 제3자의 명예를 손상시키거나 업무를 방해하는
                        ...
                        <li>
                            ...
                            <div className="box-scroll">
                                ...
                                <p className="txt">LS ELECTRIC(이하 "회사")e-Health Checker 시스템은 이용자의 개인 정보를 보호하기 위하여 「정보통신망 이용 촉진 및 정보보호 등에 관한 법률」 및 「개인정보보호법」 등 관련 법령상의 개인정보 보호 규정을 준수하고 있으며 다음과 같은 개인정보 처리 방침을 가지고 있습니다.</p>
                                <p className="txt mt-10">회사는 개인정보 처리방침을 통하여 이용자의 개인정보가 어떠한 목적과 방식으로 수집, 이용되고 있으며, 이용자의 개인정보 보호를 위해 e-Health Checker가 어떠한 조치를 취하고 있는지 알려드립니다.</p>
                                <p className="txt mt-10">본 개인정보 처리 방침은 관련 법의 개정이나 회사의 정책에 따라 변경될 수 있으며, 회사는 e-Health Checker 시스템을 통하여 이를 알려드리오니, e-Health Checker 시스템 이용 시에 수시로 확인하여 주시기 바랍니다.</p>
                                <p className="txt mt-10">
                                    1. 개인정보의 처리 목적<br />
                                    2. 처리하는 개인정보의 항목<br />
                                    3. 개인정보의 수집방법<br />
                                ...
                                <p className="txt mt-10">
                                    e-Health Checker 위탁계약 체결 시 개인정보보호법 제25조에 따라 위탁업무 수행목적 외 개인정보 처리 금지, 기술적•관리적 보호조치, 재위탁 제한, 수탁자에 대한 관리 및 감독, 개인정보보호 관련 법규의 준수, 개인정보에 대한 비밀유지, 손해배상 등 책임과 관한 사항을 계약서에 명시하고, 수탁자가
                                ...
                                <p className="txt mt-10">
                                    ...
                                    : 귀하는 위와 같이 개인정보를 제공하는 데 대한 동의를 거부할 권리가 있습니다. 그러나 동의를 거부할 경우 e-Health Checker App 서비스 이용에 제한이 있을 수 있습니다.
                                </p>
                                ...
                                <p className="txt mt-10">회사는 이용자의 정보를 수시로 저장하고 찾아내는 ' 쿠키( cookie)'를 설치 운용합니다. 쿠키란 e-Health Checker 시스템을 운영하는데 이용되는 서버가 이용자의 브라우저에 보내는 아주 작은 텍스트 파일로서 이용자의 컴퓨터 하드디스크에 저장됩니다.</p>
                                <p className="txt mt-10">
                                    1. 쿠키 사용 목적<br />
                                ...
                                <p className="txt mt-10">
                                    3. e-Health Checker 시스템에 광고를 게재하는 배너에서도 광고주나 마케팅회사에 의해 쿠키가 사용되는 경우도 있음을 알려드립니다. 이 경우 당해 쿠키는 시스템 관리와 광고주에게 제공할 통계 집계 등을 위하여 이용자들의 IP 주소를 모으기도 합니다. 당해 쿠키가 수집하는 개인정보에 관한 사항은
                                ...
                                <p className="txt mt-10">• e-Health Checker 시스템 FAQ에 수정내용 공지</p>
                            </div>
                        </li>
                        <li>
                            ...
                            <div className="box-scroll">
                                ...
                                <p className="txt dot">e-Health Checker 시스템의 기능 개선 및 추가 등 신규개발을 위한 분석 및 연구</p>
