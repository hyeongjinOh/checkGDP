    ...
    <>
      ...
      <div id="findId" className="popup-layer js-layer layer-out hidden"> {/*<!-- layer-out 클래스 : 팝업 안에 팝업일 경우는 생략 -->*/}
        <div className="popup__head">
          <h1><span role="idplz">아이디 찾기</span></h1>
        ...
        <div className="popup__footer">
          ...
          {/* {(!isFindId) && <button data-testid="loginButton" type="button" onClick={run}><span>찾기</span></button>} */}
          <button data-testid="findIdButton" type="button" onClick={run}><span>찾기</span></button>
          {/*(isFindId)&&<button type="button" ><span>비밀번호 찾기</span></button>*/}
          {(isFindId) && <button type="button" className="btn btn-txt js-open" data-pop="findPw" onClick={(e) => layerOpen(e)}><span>비밀번호 찾기</span></button>}
        </div>
      </div>
      {/*<!-- //아이디 찾기 팝업 -->*/}
    </>
