...
export default function MyAccount(props) {
            ...
            if (data) {
                if (data.codeNum == CONST.API_200) {
                    ...
                    if (passwordNew == '') {
                        ...
                        console.log("data.errorList.msg::", data.errorList[0].msg)
    ...
    // console.log("classificationCodes", classificationCode);
                    ...
                    <form action="" method="" name="popmyaccount">
                        <ul className="form__input mt-9">
                            <li>
                                ...
                                <div className="input__area">
                                    <div className="radioBox">
                                        <label htmlFor="rd1"><input type="radio" id="rd1" name="rd" disabled />Admin</label>
                                        <label htmlFor="rd2"><input type="radio" id="rd2" name="rd" disabled />Engineer</label>
                                        <label htmlFor="rd3"><input type="radio" id="rd3" name="rd" disabled />User</label>
                                    </div>
                                </div>
                            </li>
                            <li>
                                ...
                                <div className="input__area">
                                    <input type="text" id="userId2" disabled />
                                </div>
                            </li>
                            <li>
                            ...
                            <li>
                                ...
                                <div className="input__area">
                                    <input type="text" id="username3" disabled />
                                </div>
                            </li>
                            <li>
                            ...
                            <li>
                                ...
                                <div className="input__area">
                                    <input type="text" id="userId3" disabled />
                                </div>
                            </li>
                            <li>
