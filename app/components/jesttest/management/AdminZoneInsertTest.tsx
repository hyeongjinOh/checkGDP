                                            ...
                                            <div className="score">
                                                <div className="select w64">
                                                    <div className="selected">
                                                        <div className="selected-value">70</div>
                                                        <div className="arrow"></div>
                                                    </div>
                                                    <ul>
                                                        <li className="option" data-val="70">70</li>
                                                        <li className="option" data-val="75">75</li>
                                                        <li className="option" data-val="80">80</li>
                                                        <li className="option" data-val="85">85</li>
                                                        <li className="option" data-val="90">90</li>
                                                    </ul>
                                                </div>
                                            </div>
                                        </div>
