...
function EhcServicesTest(props) {
  //trans, ref, navigate
        ...
        <div className="e-checkbox">
          ...
          <ul className="bottom">
            <li>
              ...
              <div className="buttonbox">
                <a onClick={(e) => onClickGoLink(false, CONST.URL_DEVICESLIFE)}>
                  <div>
            ...
            <li>
              ...
              <div className="buttonbox">
                <a onClick={(e) => onClickGoLink(false, CONST.URL_HELP)}>
                  <div>
...
export default EhcServicesTest;