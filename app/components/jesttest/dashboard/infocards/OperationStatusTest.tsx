...
function OperationStatusTest(props) {
  //trans, ref, navigate
    ...
    <>
      ...
      <div className="box__body">
        <ul className="datalist">
          ...
          <li>
            <p className="tit">{/* <img src={require("/static/img/icon_admin@3x.png")} style={{ "width": "20px", "height": "20px" }} className="mr-4" alt="" /> */}User</p>
            <p><strong>{opStatus.userCount}</strong> 개</p>
          </li>
          <li>
            <p className="tit">{/* <img src={require("/static/img/icon_treesub3@3x.png")} style={{ "width": "9px", "height": "14px" }} className="mr-8 ml-6" alt="" /> */}등록된 설비</p>
...
export default OperationStatusTest;