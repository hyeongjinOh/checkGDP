...
//component
import DndDashboardTreeTest from "./DndDashboardTreeTest";
import DndDashboardTest from "./DndDashboardTest";

function DndDashboardMainTest(props) {
  //ref, trans
  ...
  //clog("DND INIT : TREE : " + JSON.stringify(selTree));
  //clog("DND INIT : TREE : " + JSON.stringify(locTree));
  return (
  <>
    {/*{/*<!--main, 컨테이너영역 -->*/}
        ...
        <div className="top-wrap" ref={mobileRef}>
          ...
          <div className="right">
            <button type="button"
              ...
              onClick={(e)=>onClickIsDraggable(e, !isDraggable)}
            >
...
export default DndDashboardMainTest;
