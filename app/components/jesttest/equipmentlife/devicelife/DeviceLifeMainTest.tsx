...
import DeviceLifeTreeTest from "./DeviceLifeTreeTest";
import DeviceLifeCRUDTest from "./DeviceLifeCRUDTest";


function DeviceLifeMainTest(props) {
    //recoil
    ...
    return (
        <>
            <main className="container admin-site">
                            ...
                            <section className="swiper-section">
                                <div className="swiper-container mySwiper">
                                    <div className="swiper-wrapper">
                                        ...
                                        <div className="swiper-slide tab on" data-tab="tab-1"><p>설비수명 인자 설정</p></div>
                                    </div>
                                </div>
                            </section>
...
export default DeviceLifeMainTest;