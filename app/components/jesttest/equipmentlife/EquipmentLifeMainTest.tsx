...
import DeviceLifeMainTest from "./devicelife/DeviceLifeMainTest";
import DeviceReportMainTest from "./devicereport/DeviceReportMainTest";
//component

function EquipmentLifeMainTest(props) {
    //recoil
...
export default EquipmentLifeMainTest;