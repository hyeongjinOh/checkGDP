...
function ZoneView(props) {
    ...
    useEffect(() => {
        ...
        if (retCompany) {
            //clog("IN SITEVIEW : RES : " + JSON.stringify(retCompany));        
            if (retCompany.codeNum == CONST.API_200) {
                (async () => { // IFFE(Immediately Invoked Function Expression)은 함수가 정의되자마자 실행되는 자바스크립트 기술입니다.
                    ...
                    if (retZone.codeNum === CONST.API_200) {
                        //clog("IN ZONEVIEW : RES : " + JSON.stringify(retCompany.body));
                        //clog("IN SITEVIEW : RES : " + JSON.stringify(retCompany.body.companyName));
                        //clog("IN ZONEVIEW : RES : " + JSON.stringify(retZone.body));
    ...
    return (
        <>
            ...
            {/* <div ref={mobileRef}
                    className="area__right">
                    <p>선택한 회사의 사업장 정보가 없습니다.</p>
                    <p>선택한 회사의 사업장 정보가 없습니다.</p>
                </div> */}
                ...
                <>
                    <div className="popup__body">
                        ...
                        <ul className="page-loca">
                            ...
                            <li>{zoneInfo.zone.zoneName} 사업장</li>
                        </ul>
                        <div className="page-top">
                            <h2>{zoneInfo.company.companyName} {zoneInfo.zone.zoneName} 사업장</h2>
                        ...
                        <div className="area__right_content workplace__info workplace__main">
                            ...
                            <div className="content__list">
                                <div className="listbox__top">
                                    <h3>상세사업장 목록</h3>
                                    <button type="button" className="add__item" onClick={(e) => onClickSubZoneInsert(e)}><span>상세사업장 추가</span></button>
                                </div>
