                    ...
                    <div className="tbl__top">
                        ...
                        <div className="right">
                            <div className="searcharea">
                                ...
                                <input type="text" placeholder={t("MESSAGE.기기명을입력하세요")} className="d-sm-block-toggle" value={searchText} onChange={(e) => setSearchText(e.target.value)} />
                            ...
                            <tbody>
                                {itemCheckList.map((item, idx) => (
                                    <tr key={item.itemId + "_premium_" + idx} className={(item.itemId === curItem.itemId) ? "focused" : ""}>
                                        ...
                                        {(isMobile) ?
                                            (userInfo.role == CONST.USERROLE_USER) ?/* || ((searchInput.clientHeight <= 0) && (searchInput.clientWidth <= 0)))  */
                                                // by 20221115 - hjo engineer,admin 계정 팝업 변겯
                                        ...
                                        <td className="d-lm-none">
                                            {(!item.assessment.isTempSave) /*((item.assessment.isTempSave==null)||(item.assessment.isTempSave==false))*/
                        ...
                        : (list.role == CONST.USERROLE_USER) ?
                          ...
                          : "nodata"
                            ...
                            <li>
                                ...
                                <p className="txt">LS전자</p>
                            </li>
                            <li>
                                <p className="tit">요청자 이름</p>
                                <p className="txt">bsKim</p>
                            </li>
                            <li>
                                <p className="tit">요청자 E-mail(ID)</p>
                                <p className="txt">test@test.com</p>
                            </li>
                            <li>
                                <p className="tit">요청자 연락처</p>
                                <p className="txt">01000000003</p>
                            </li>
                            <li>
                                <p className="tit" >시리얼번호</p>
                                <p className="txt" >131002-1574.05</p>
                            </li>

                            <li>
                                <p className="tit">최근점검일</p>
                                <p className="txt">2022-11-15</p>
