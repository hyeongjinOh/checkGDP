...
function AdvancedListTest() {
  ...
  useEffect(() => {
    ...
    if (data) {
      if (data.codeNum == 200) {
        clog("IN ADVANCED LIST : " + JSON.stringify(data.data));
  ...
  function onClickSearchSelect(e) {
    // select active 액션
    const selectBoxElements = document.querySelectorAll("#advanced_search_select");
    //
    ...
    function selectOption(optionElement) {
      const selectBox = optionElement.closest("#advanced_search_select");
    ...
    const targetElement = e.target;
    const isSelect = targetElement.classList.contains("search_select") || targetElement.closest("#advanced_search_select");
    if (isSelect) {
      return;
    }
    const allSelectBoxElements = document.querySelectorAll("#advanced_search_select");
          ...
          <div className="right">
            <div className="searcharea">
              ...
              <div className="searchinput">
                ...
                <div id="advanced_search_select" className="select" onClick={(e) => onClickSearchSelect(e)}>
            ...
            <tbody>
              ...
              {itemCheckList.map((item, idx) => (
                <tr key={item.id + "_advanced_" + idx}>
                  ...
                  <td>
                    <button type="button" className="bg-yellow"><span>요청</span></button>
                  </td>
                </tr>))}
              {/**
                <tr>
                    ...
                    <td>
                        <button type="button" className="bg-middlegray"><span>접수 완료</span></button>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <button type="button" className="bg-lightgray"><span>요청완료</span></button>
                    </td>
                </tr>
                <tr>
                    <td className="txt-left">VCB # 12</td>
                    ...
                    <td>
                        <button type="button" className="bg-pink"><span>진단&컨설팅</span></button>
                    </td>
                </tr>
                <tr>
                    <td className="txt-left">VCB # 12</td>
...
export default AdvancedListTest;