...
function AdvancedList(props) {
    ...
    const { data: data, error, isLoading, reload, run } = useAsync({
        ...
        watch: appPath + listMode + curItem.assessment.assessmentId + stepDone + isMobile
                                ...
                                <tr className={"focused"}>
                                    ...
                                    <td className="txt-left">
                                        <span className="tooltip">
                                            ...
                                            <span className="tooltip-text">NO_PANEL</span>
                                        </span>
                                    </td>
                                    ...
                                    <td className="txt-left d-lm-none">
                                        <p className="ellipsis">
                                            <span className="tooltip">
                                                ...
                                                482110087-108-004
                                                {/* <!--툴팁 내용--> */}
                                                <span className="tooltip-text">482110087-108-004</span>
                                            </span>
                                        </p>
                                    </td>
                                    {/* <!--220530, 클래스 d-sm-none 추가 : 모바일버전에서 display:none--> */}
                                    <td className="txt-left d-lm-none">김방방</td>
                                    <td className="checkdate txt-left js-open" data-pop={"data-detail"}>
                                        "기록없음"
                                    </td>
                                    ...
                                    <td>
                                        {/*ADVENCED_ING : 진행중 */}
                                        <button type="button" data-testid="advancedStep1" className="bg-yellow">
                                            <span>요청</span>
                                        </button>
                                        <button type="button" data-testid="advancedStep2" className="bg-lightgray">
                                            <span>요청완료</span>
                                        </button>
                                        <button type="button" data-testid="advancedStep3" className="bg-middlegray">
                                            <span>접수 완료</span>
                                        </button>
                                        <button type="button" data-testid="advancedStep4" className="bg-pink">
                                            <span>진단/컨설팅</span>
                                        </button>
                                        <button type="button" data-testid="advancedStep5" className="bg-navy">
                                            <span>진행중</span>
                                        </button>
                                    </td>
                                </tr>
