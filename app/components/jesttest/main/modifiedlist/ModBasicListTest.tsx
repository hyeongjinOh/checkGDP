                    ...
                    <div className="tbl-list">
                     ...
                     onClick={(e) => onClickSort(e)} data-value="itemName"><span>Panel 명</span></th> */}
                                    <th scope="col"
                                        ...
                                        onClick={(e) => onClickSort(e)} data-value="panelName"><span>Panel 명</span></th>
                                    {/*<!--sort 내림차순-->*/}
                                ...
                                <tr className={"focused"}>
                                    ...
                                    <td className="txt-left d-lm-none">
                                        <p className="ellipsis">
                                            {/* <!--기존 내용--> */}
                                            <span className="tooltip">
                                                220512-2715.07                                                    {/* <!--툴팁 내용--> */}
                                                <span className="tooltip-text">220512-2715.07</span>
                                            </span>
                                        </p>
                                    </td>
                                    {/* <!--220530, 클래스 d-sm-none 추가 : 모바일버전에서 display:none--> */}
                                    ...
                                    <td>
                                        {/*BASIC_ING : 진행중 */}
                                        <button type="button"
                                            data-testid="basicstart"
                                            className="bg-purple"                                            >
                                            <span>시작</span> {/*Basic 시작은 ROLE_USER만 할 수 있음 */}
                                        </button>
